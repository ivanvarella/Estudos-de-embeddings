...
def main():
    ...
    print(f"{'✅' if docker_available else '⚠️ '} Docker: {'Disponível' if docker_available else 'Não disponível'}")
    print(f"{'✅' if openai_configured else '⚠️ '} OpenAI: {'Configurado' if openai_configured else 'Não configurado'}")
    
    print("\n🎯 PRÓXIMOS PASSOS:")
    print("1. Execute o notebook: jupyter notebook Seção5.1_Embeddings.ipynb")
